...
\hspace{-1.2ex}\begin{column}{0.515\textwidth}
	\includegraphics[width=1.21\columnwidth,trim=0.75cm 0 0 0,clip]{../r/plots/cv-adaboost-st-diab.pdf}
\end{column}
\end{columns}
...
% criterio basato sull'influenza di ogni variabile nel ridurre la loss function
% per ogni variabile viene fatta la media su tutte le volte che è scelta per partizionare una regione
...
\hspace{-1.3ex}\begin{column}{0.515\textwidth}
	% stochastic setting
	% averaged over 30 adaboost runs
